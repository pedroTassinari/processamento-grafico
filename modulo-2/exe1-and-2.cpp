...
int main()
{
	...
	VAOs.push_back(createTriangle(0.4, 0.6, 0.6, 0.9, 0.8, 0.6));
	VAOs.push_back(createTriangle(-0.2, -0.1, 0.0, 0.3, 0.2, -0.1));
	VAOs.push_back(createTriangle(-0.8, -0.6, -0.6, -0.3, -0.4, -0.6));
	VAOs.push_back(createTriangle(0.4, -0.6, 0.6, -0.3, 0.8, -0.6));
